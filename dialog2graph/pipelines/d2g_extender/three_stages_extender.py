...
from dialog2graph.pipelines.d2g_extender.prompts import (
...
class LLMGraphExtender(DGBaseGenerator):
    """Graph generator which iteratively takes step dialogs and adds them to graph
    ...
    def _add_step(self, dialogs: list[Dialog], graph: Graph) -> Graph:
        dialogs_text = ""
        ...
        try:
            sampled_dialogs = dialog_sampler.invoke(
                graph,
