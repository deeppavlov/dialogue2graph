...
from dialog2graph.pipelines.core.algorithms import (
    DialogAugmentation,
    DialogGenerator,
    GraphGenerator,
    GraphExtender,
)
from dialog2graph.pipelines.helpers.parse_data import (
    RawDGParser,
    PipelineRawDataType,
    PipelineDataType,
)
from dialog2graph.pipelines.report import PipelineReport
from dialog2graph.metrics import compare_graphs_full, compare_graphs_light
...
class BasePipeline(BaseModel):
    ...
    steps: list[
        Union[DialogGenerator, DialogAugmentation, GraphGenerator, GraphExtender]
