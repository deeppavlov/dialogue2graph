...
---------------------------
Functions that check Graphs and Dialogues with direct string matching
...
def match_triplets_dg(G1: Any, dialogues: List[Any]) -> Dict[str, Any]:
    """
    Check if all triplets from dialogues are present in G1 or vice versa.
...
def are_paths_valid(G1: Any, dialogues: List[Any]) -> Dict[str, Any]:
    """
    Check if dialogues form valid paths in G1.
