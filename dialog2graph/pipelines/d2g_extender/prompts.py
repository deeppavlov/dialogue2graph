extending_prompt_part_1 = """Your input is a dialog graph from customer chatbot system.
Your task is to extend set of nodes for the dialog graph with list of input dialogs.
...
10) Doublecheck that all the assistant's utterances from the input dialogs are present in resulting set of nodes,
...
12) Here go examples for list of dialogs and corresponding set of nodes.
{examples}
This is the end of examples
I will give you the list of dialogs, your task is to extend a set of nodes of the graph above with assistant's utterances from the dialogs according to the rules and examples above.
The list of dialogs: """
