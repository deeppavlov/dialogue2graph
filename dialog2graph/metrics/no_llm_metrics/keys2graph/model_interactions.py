...
def generate_annotation(
    ...
    """
    Generates annotation JSON from a dialog graph by calling LLM.
...
def build_dynamic_graph_prompt(keys_dict: Dict[str, Any]) -> str:
    ...
    lines.append(
        ...
        "Use them to create a new dialog graph in JSON format.\n\n"
...
def generate_dialog_graph_by_keys(
    ...
    """
    Generate a new dialog graph from a dict of keys using LLM.
    """
    api_key = os.environ["OPENAI_API_KEY"]
    base_url = os.environ["OPENAI_API_BASE"]
