...
from dialog2graph.pipelines.core.schemas import ReasonGraph
from dialog2graph.pipelines.core.graph import BaseGraph, Metadata
from dialog2graph.pipelines.model_storage import ModelStorage
from dialog2graph.pipelines.d2g_light.group_nodes import group_nodes
...
class LightGraphGenerator(DGBaseGenerator):
    """Graph generator from list of dialogs. Based on algorithm with embedding similarity usage.
