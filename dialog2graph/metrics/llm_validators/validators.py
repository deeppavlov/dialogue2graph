...
def is_greeting_repeated_emb_llm(
    ...
    """
    Check if greeting is repeated within dialogs using pairwise distance and LLM assessment.
...
def is_dialog_closed_too_early_emb_llm(
    ...
    """
    Check if assistant tried to close dialog in the middle using pairwise distance and LLM assessment.
