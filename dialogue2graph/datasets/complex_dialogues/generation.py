...
from dialogue2graph.metrics.llm_metrics import are_triplets_valid, is_theme_valid, graph_validation
...
class CycleGraphGenerator(TopicGraphGenerator):
    ...
    async def ainvoke(self, *args, **kwargs):
        ...
        """
        raise NotImplementedError("Async version of invoke is not implemented")
